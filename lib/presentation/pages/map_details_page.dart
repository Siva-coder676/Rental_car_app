    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          Positioned(
              bottom: 0, right: 0, left: 0, child: carDetailsCard(car: car))
        ],
      ),
    );
  }
...
Widget featureIcons() {
  return Row(
    mainAxisAlignment: MainAxisAlignment.spaceBetween,
    children: [
      feautureIcon(Icons.local_gas_station, 'Diesel', 'Common Rail'),
      feautureIcon(Icons.speed, 'Acceleration', '0 - 100km/s'),
      feautureIcon(Icons.ac_unit, 'Cold', 'Temp Control')
    ],
  );
}
